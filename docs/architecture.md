...
- **Interactivity**: Multi-touch zoom (up to 20x), playhead/segment edge drag gestures, auto-panning, and anchored delete/split actions on long press. Long press resolves KEEP segments before the playhead target when the playhead overlaps a segment.
