...
* **Segment Context Actions**: Long-press a kept timeline segment to reveal anchored delete and split icons at the press position, including when the playhead overlaps the segment; selected segments remain clearly highlighted.
