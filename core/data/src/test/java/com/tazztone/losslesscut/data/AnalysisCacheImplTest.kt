...
class AnalysisCacheImplTest {
    ...
    fun frameAnalysis_saveAndGet_worksCorrectly() {
        ...
        cache.saveFrameAnalysis(sampleClip, VisualStrategy.BLACK_FRAMES, 1000L, analysis)
        val loaded = cache.getFrameAnalysis(sampleClip, VisualStrategy.BLACK_FRAMES, 1000L)
